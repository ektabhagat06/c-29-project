...
box13 = new BlueBox(520,310,20,30);
box14 = new RedBox(520,310,20,30);
box15 = new GreenBox(520,310,20,30);
...
box37 = new YellowBox(600,45,20,30);
box38 = new BlueBox(530,45,20,30);
box39 = new GreenBox(550,45,20,30);

ball= new Ball(0,0,50);

spring =new Platform(400,290,800,20);

groundOvering = new Platform(550,160,200,20);

}

function draw?() {
    Background(247,232,178);
